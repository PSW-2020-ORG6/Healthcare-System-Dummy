    ...
    public class SecretaryViewModel : INotifyPropertyChanged
    {
            ...
            get => _secretary.Name; set
            {
                if (value != _secretary.Name)
                    _secretary = new Secretary(_secretary.SerialNumber, value, _secretary.Surname, _secretary.Id,
                        _secretary.DateOfBirth, _secretary.Contact, _secretary.Email, _secretary.Address, _secretary.Password);
            ...
            set
            {
                if (value != _secretary.Address.Street.ToString())
                {
                    ...
                    _secretary = new Secretary(_secretary.SerialNumber, _secretary.Name, _secretary.Surname, _secretary.Id,
                      _secretary.DateOfBirth, _secretary.Contact, _secretary.Email, new Address(value), _secretary.Password);
                }
        ...
        public string BirthDate
        {
            get => _secretary.DateOfBirth.ToString("yyyy-MM-dd"); set
            {
                if (value != _secretary.DateOfBirth.ToString())
                    _secretary = new Secretary(_secretary.SerialNumber, _secretary.Name, _secretary.Surname, _secretary.Id,
                     Convert.ToDateTime(value), _secretary.Contact, _secretary.Email, _secretary.Address, _secretary.Password);
        ...
        public string Contact
        {
            get => _secretary.Contact; set
            {
                ...
                {
                    _secretary = new Secretary(_secretary.SerialNumber, _secretary.Name, _secretary.Surname, _secretary.Id,
                      _secretary.DateOfBirth, value, _secretary.Email, _secretary.Address, _secretary.Password);
                }
        ...
        public string Email
        {
            get => _secretary.Email; set
            {
                ...
                {
                    _secretary = new Secretary(_secretary.SerialNumber, _secretary.Name, _secretary.Surname, _secretary.Id,
                      _secretary.DateOfBirth, _secretary.Contact, value, _secretary.Address, _secretary.Password);
                }
                OnPropertyChanged("Contact");
            }
        }
