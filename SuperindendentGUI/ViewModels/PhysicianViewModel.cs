    ...
    public class PhysicianViewModel : INotifyPropertyChanged
    {
            ...
            get => Physitian.Name; set
            {
                if (value != Physitian.Name)
                    _physitian = new Physitian(_physitian.SerialNumber, value, _physitian.Surname, _physitian.Id,
                        _physitian.DateOfBirth, _physitian.Contact, _physitian.Email, _physitian.Address, _physitian.WorkSchedule, _physitian.Password, _physitian.Specialization);
        ...
        public string BirthDate
        {
            get => Physitian.DateOfBirth.ToString("yyyy-MM-dd"); set
            {
                if (value != Physitian.DateOfBirth.ToString())
                    _physitian = new Physitian(_physitian.SerialNumber, _physitian.Name, _physitian.Surname, _physitian.Id,
                     Convert.ToDateTime(value), _physitian.Contact, _physitian.Email, _physitian.Address, _physitian.WorkSchedule, _physitian.Password, _physitian.Specialization);
        ...
        public string Contact
        {
            get => Physitian.Contact; set
            {
                ...
                {
                    _physitian = new Physitian(_physitian.SerialNumber, _physitian.Name, _physitian.Surname, _physitian.Id,
                      _physitian.DateOfBirth, value, _physitian.Email, _physitian.Address, _physitian.WorkSchedule, _physitian.Password, _physitian.Specialization);
                }
        ...
        public string Email
        {
            get => Physitian.Email; set
            {
                ...
                {
                    _physitian = new Physitian(_physitian.SerialNumber, _physitian.Name, _physitian.Surname, _physitian.Id,
                      _physitian.DateOfBirth, _physitian.Contact, value, _physitian.Address, _physitian.WorkSchedule, _physitian.Password, _physitian.Specialization);
                }
                OnPropertyChanged("Contact");
            }
        }
